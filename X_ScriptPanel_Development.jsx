...
function ScriptPanel ()
{
    ...
    SCRIPTFOLDERS = [
        { name: "Development Scripts", folderPath: networkScriptPath + "dev_scripts/", square: "square_none", notes: "" },
        { name: "Mockup Exporter Scripts", folderPath: networkScriptPath + "mockup_exporter_scripts/", square: "square_none", notes: "" },
        { name: "Template Builder Scripts", folderPath: networkScriptPath + "template_builder/", square: "square_none", notes: "" },
    ]
    FAVORITES = [];
    ...
    function miniTab ()
    {
        var title = ( SETTINGS.windowGraphics ) ? '' : 'Development Scripts';
